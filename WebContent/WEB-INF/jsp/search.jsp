...
<div class="mui-container" style="padding:5px">
	<div class="mui-panel">
	  ...
	  <span style="font-size:13px;padding:6px 24px 6px 0px;margin:5px;float:left"><a href="${ pageContext.request.contextPath}/main"><strong>帖子列表</strong></a>&nbsp;/&nbsp;<strong>搜索结果</strong></span>
	  </div>
	  ...
	  <table class="mui-table mui-table--bordered" style="margin-top:20px">
		  ...
		  <tbody>
		  <!-- 输出帖子列表 -->
		  <c:forEach items="${SEARCH_RESULT}" var="thread">
			    <tr>
			      <td colspan="2">
